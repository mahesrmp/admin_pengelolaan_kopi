                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <img src="{{ $panen['gambar'] }}" class="d-block w-50" alt="...">
                                    </div>
                                    ...
                                    {{-- <div class="card-body">
                                                        ...
                                                        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                                            <div class="carousel-indicators">
                                                                @php
                                                                    $gambarCount = count($panens); // Menghitung jumlah gambar dari data yang diterima
                                                                @endphp
                                                            ...
                                                            <div class="carousel-inner">
                                                                @foreach ($panens as $key => $panen)
                                                                    <div class="carousel-item {{ $key === 0 ? 'active' : '' }}">
                                                                        @if (isset($panen['gambar']))
                                                                            <img src="{{ $panen['gambar'] }}" class="d-block w-100" alt="...">
                                                                        @else
